        ...
        var KdTree = function (pointList) {
            ...
            this.build = function(pointList, dim, parent, isLeft) {
                ...
                if(!parent){
                    ...
                    if(isLeft){
                        node.bbox=new BoundingBox(parent.bbox.xmin, parent.bbox.ymin, parent.point.x, parent.bbox.ymax,node.point,1);
                    }else {
                        node.bbox=new BoundingBox(parent.point.x, parent.bbox.ymin,parent.bbox.xmax,parent.bbox.ymax,node.point,1);
                    }
                }
